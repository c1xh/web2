			...
			<section class="ab-photo pr border-1px-bottom">
				...
				<div class="swiper-container">
				    <div class="swiper-wrapper" v-if="infoObj.artistes">
				        <div class="swiper-slide" v-for="item in infoObj.artistes.actor" :key="item.id">
				        	<div class="am-img pr">
			...
			<section class="ab-photo crew-ab-photo pr border-1px-bottom">
				...
				<div class="swiper-container crew-swiper-container">
				    <div class="swiper-wrapper">
				        <div class="swiper-slide" v-for="item in infoObj.trailer"  :key="item.id">
...
import { hotEvaluation } from '../components/Index/hotEvaluation'
export default{
	data () {
		return {
			hideSomething: true,
